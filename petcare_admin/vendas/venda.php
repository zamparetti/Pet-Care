...
<head>
    ...
    <title>PetCare Admin - Vendas</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            <div class="container-fluid">
                ...
                <h1 class="h3 mb-2 text-gray-800">Gerenciamento de Vendas</h1>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?= $venda['nm_vendedor']; ?></td>
                                            <td><?= $venda['nm_cliente']; ?></td>
                                            <td><?= $venda['nm_natureza']; ?></td>
                                            <td><a href="editar.php?id=<?= $venda['id']; ?>" class="btn btn-warning">Editar</a></td>
                                            <td><a href="excluir.php?id=<?= $venda['id']; ?>" class="btn btn-danger">Excluir</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
