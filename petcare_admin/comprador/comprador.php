...
// Consulta para pegar os compradores
$sql = $conn->prepare("SELECT * FROM tb_comprador LIMIT 30");
$sql->execute();
$result = $sql->fetchAll();

// Filtrando pela busca, se houver
if (!empty($_POST['busca'])) {
    $buscar = "%" . $_POST['busca'] . "%";
    $sql = $conn->prepare("SELECT * FROM tb_comprador WHERE nm_comprador LIKE :buscar");
...
<head>
    ...
    <title>PetCare Admin - Compradores</title>
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../index.php">
            ...
            <div class="text-center d-none d-md-inline">
             ...
             <hr class="sidebar-divider d-none d-md-block">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="comprador.php">
                        <i class="fas fa-user fa-2x text-gray-300"></i>
                        <span>Comprador</span>
                    </a>
                </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Gerenciamento de Compradores</h1>

                    <!-- Formulário de busca -->
                    <form action="" method="post" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="busca" id="busca" class="form-control" placeholder="Nome do Comprador">
                    ...
                    <!-- Botão para adicionar novo comprador -->
                    <a href="adicionar.php" class="btn btn-success mb-3">Novo Comprador</a>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $linha) {
                                            echo "<tr>";
                                            echo "<td>" . htmlspecialchars($linha['id_comprador']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['nm_comprador']) . "</td>";
                                            ?>
                                            <td class="text-center">
                                                <a href="editar.php?id=<?php echo $linha['id_comprador']; ?>" class="btn btn-warning">Editar</a>
                                            </td>
                                            <td class="text-center">
                                                <a href="excluir.php?id=<?php echo $linha['id_comprador']; ?>" class="btn btn-danger" onclick="return confirm('Deseja Excluir?');">Excluir</a>
                                            </td>
                                            <?php
                                            echo "</tr>";
                                        }
