...
<head>
    ...
    <title>PetCare Admin - Vendedores</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Gerenciamento de Vendedores</h1>

                    <form action="" method="post" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="busca" class="form-control" placeholder="Insira o nome ou a comissão do vendedor" aria-label="Buscar Vendedor">
                    ...
                    <a href="adicionar.php" class="btn btn-success mb-3">Novo Vendedor</a>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($result as $linha) {
                                            echo "<tr>";
                                            echo "<td>" . htmlspecialchars($linha['id_vendedor']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['nm_vendedor']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['perc_comissao']) . "</td>";
                                            echo "<td class='text-center'><a href='editar.php?id=" . htmlspecialchars($linha['id_vendedor']) . "' class='btn btn-warning'>Editar</a></td>";
                                            echo "<td class='text-center'><a href='excluir.php?id=" . htmlspecialchars($linha['id_vendedor']) . "' class='btn btn-danger' onclick='return confirm(\"Deseja realmente excluir?\");'>Excluir</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
