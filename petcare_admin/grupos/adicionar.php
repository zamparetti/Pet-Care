...
<head>
    ...
    <title>PetCare Admin - Adicionar Grupo</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Adicionar Grupo</h1>
                    <form action="adicionar_submit.php" method="post">
                        <div class="form-group">
                            <label for="nm_grupo">Nome do Grupo:</label>
                            <input type="text" class="form-control" name="nm_grupo" id="nm_grupo" placeholder="Nome do grupo" required>
                        </div>
                        <button type="submit" class="btn btn-primary">Enviar</button>
                    </form>
                    <a href="grupo.php" class="btn btn-secondary">Voltar</a>
                </div>
            </div>
