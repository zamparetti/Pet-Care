...
<head>
    ...
    <title>PetCare Admin - Formas de Pagamento</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h1 class="h3 mb-2 text-gray-800">Gerenciamento de Formas de Pagamento</h1>
                    ...
                    <form action="" method="post" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="busca" id="busca" class="form-control" placeholder="Nome da forma de pagamento">
                    ...
                    <a href="adicionar.php" class="btn btn-success mb-3">Novo</a>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        // Buscando as formas de pagamento com filtro
                                        ...
                                        foreach ($result as $linha) {
                                            echo "<tr>";
                                            echo "<td>" . htmlspecialchars($linha['id_forma_pgto']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['nm_forma_pgto']) . "</td>";
                                            echo "<td><a href='editar.php?id=" . htmlspecialchars($linha['id_forma_pgto']) . "' class='btn btn-warning'>Editar</a></td>";
                                            echo "<td><a href='excluir.php?id=" . htmlspecialchars($linha['id_forma_pgto']) . "' class='btn btn-danger' onclick='return confirm(\"Você tem certeza que deseja excluir?\");'>Excluir</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
