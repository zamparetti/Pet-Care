...
<head>
    ...
    <title>PetCare Admin - Naturezas</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Gerenciamento de Naturezas</h1>

                    <form action="" method="post" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="busca" id="busca" class="form-control" placeholder="Insira a Natureza">
                    ...
                    <a href="adiciona_natureza.php" class="btn btn-success mb-3">Nova Natureza</a>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if ($buscar) {
                                            ...
                                            $sql = $conn->prepare("SELECT * FROM tb_natureza ORDER BY nm_natureza");
                                        }
                                        $sql->execute();
                                        $result = $sql->fetchAll();
                                        ...
                                        foreach ($result as $linha) {
                                            echo "<tr>";
                                            echo "<td>" . htmlspecialchars($linha['id_natureza']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['nm_natureza']) . "</td>";
                                            echo "<td class='text-center'><a href='editar_natureza.php?id=" . htmlspecialchars($linha['id_natureza']) . "' class='btn btn-warning'>Editar</a></td>";
                                            echo "<td class='text-center'><a href='excluir.php?id=" . htmlspecialchars($linha['id_natureza']) . "' class='btn btn-danger' onclick='return confirm(\"Você tem certeza que deseja excluir esta natureza?\");'>Excluir</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
