...
<head>
    ...
    <title>PetCare Admin - Unidades</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-2 text-gray-800">Gerenciamento de Unidades</h1>

                    <form action="" method="post" class="mb-4">
                        <div class="input-group">
                            <input type="text" name="busca" id="busca" class="form-control" placeholder="Nome ou Sigla">
                    ...
                    <a href="adicionar.php" class="btn btn-success mb-3">Nova Unidade</a>
                                ...
                                <table class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        if (!empty($_POST['busca'])) {
                                            $buscar = "%" . $_POST['busca'] . "%";
                                            $sql = $conn->prepare("SELECT * FROM tb_unidade WHERE nm_unidade LIKE :buscar OR sigla_unidade LIKE :buscar");
                                        ...
                                        foreach ($result as $linha) {
                                            echo "<tr>";
                                            echo "<td>" . htmlspecialchars($linha['id_unidade']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['nm_unidade']) . "</td>";
                                            echo "<td>" . htmlspecialchars($linha['sigla_unidade']) . "</td>";
                                            echo "<td class='text-center'><a href='editar.php?id=" . htmlspecialchars($linha['id_unidade']) . "' class='btn btn-warning'>Editar</a></td>";
                                            echo "<td class='text-center'><a href='excluir.php?id=" . htmlspecialchars($linha['id_unidade']) . "' class='btn btn-danger' onclick='return confirm(\"Deseja excluir?\");'>Excluir</a></td>";
                                            echo "</tr>";
                                        }
                                        ?>
                                    </tbody>
