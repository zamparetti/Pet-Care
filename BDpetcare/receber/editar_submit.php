...
$sql=$conn->prepare("UPDATE tb_parcela set receber_id= :receber_id, dt_emissao_p=:dt_emissao_p, dt_recto=:dt_recto, dt_vencto=:dt_vencto, vl_juros=:vl_juros, vl_multa=:vl_multa, vl_parcela=:vl_parcela, vl_recebido=:vl_recebido, vl_tot_receber=:vl_tot_receber, nro_doc=:nro_doc
